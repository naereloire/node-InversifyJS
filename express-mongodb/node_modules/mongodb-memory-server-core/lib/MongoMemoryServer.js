        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (force) {
                ...
                if (utils_1.isNullOrUndefined(res)) {
                    ...
                    if (semver_1.lt(process.version, '12.10.0')) {
                        // this has to be used for below 12.10 (exclusive), because nodejs did not have an recursive delete
                        try {
                            const rimraf = (yield Promise.resolve().then(() => tslib_1.__importStar(require('rimraf')))).sync;
                            rimraf(dbPath);
                        }
                        catch (err) {
                    ...
                    else if (semver_1.lt(process.version, '14.14.0')) {

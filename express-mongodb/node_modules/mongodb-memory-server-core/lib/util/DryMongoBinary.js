...
class DryMongoBinary {
    ...
    static generateOptions(opts) {
        var _a, _b;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const defaultVersion = (_a = resolveConfig_1.resolveConfig(resolveConfig_1.ResolveConfigVariables.VERSION)) !== null && _a !== void 0 ? _a : '4.0.20';
            ...
            const final = {
                ...
                downloadDir: (opts === null || opts === void 0 ? void 0 : opts.downloadDir) || '',
                os: (_b = opts === null || opts === void 0 ? void 0 : opts.os) !== null && _b !== void 0 ? _b : this.cachedGetOs,
                arch: (opts === null || opts === void 0 ? void 0 : opts.arch) || os_1.arch(),
                systemBinary: resolveConfig_1.resolveConfig(resolveConfig_1.ResolveConfigVariables.SYSTEM_BINARY) || '',
            };
    ...
    static generatePaths(opts) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (yield utils_1.pathExists(legacyHomeCache)) {

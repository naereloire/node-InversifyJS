...
var MongoDbConfiguration = (function () {
    ...
    MongoDbConfiguration.prototype.connect = function () {
        return __awaiter(this, void 0, void 0, function () {
            var connectionString, mongooseInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        connectionString = this.buildConnectionString();
                        return [4, mongoose_1.default.connect(connectionString, {
                                useNewUrlParser: true, useUnifiedTopology: true
                            })];
                    case 1:
                        mongooseInstance = _a.sent();
    ...
    MongoDbConfiguration.prototype.buildConnectionString = function () {
        ...
        var credentials = mongoDbUsername && mongoDbPassword ? mongoDbUsername + ":" + mongoDbPassword + "@" : '';

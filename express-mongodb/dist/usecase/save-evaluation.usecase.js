...
exports.SaveEvaluation = void 0;
var dependency_identifiers_1 = require("../config/dependecy-injection/dependency-identifiers");
var inversify_1 = require("inversify");
var SaveEvaluation = (function () {
    function SaveEvaluation(evaluationGateway) {
        this.evaluationGateway = evaluationGateway;
    }
    SaveEvaluation.prototype.execute = function (evaluation) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.evaluationGateway.saveEvaluation(evaluation)];
            });
        });
    };
    SaveEvaluation = __decorate([
...
//# sourceMappingURL=save-evaluation.usecase.js.map